...
from .const import CONF_FUEL_TYPES, CONF_STATIONS, DATA_NSW_FUEL_STATION
...
async def async_setup_entry(
    ...
    """Set up NSW Fuel Station sensors from a config entry."""
    coordinator: NSWFuelStationCoordinator = hass.data[DATA_NSW_FUEL_STATION][
        entry.entry_id
    ]
    stations: list[int] = entry.options[CONF_STATIONS]
    fuel_types: list[str] = entry.options[CONF_FUEL_TYPES]
